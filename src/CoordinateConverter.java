public class CoordinateConverter
{
	...
	public CoordinateConverter converterCopier(){
		CoordinateConverter newConverter = new CoordinateConverter();
		newConverter.screenHeight = this.screenHeight;
		newConverter.screenWidth = this.screenWidth;
		newConverter.minMathX = this.minMathX;
		newConverter.maxMathX = this.maxMathX;
		newConverter.minMathY = this.minMathY;
		newConverter.maxMathY = this.maxMathY;
		newConverter.xRatio = this.xRatio;
		newConverter.yRatio = this.yRatio;
		return newConverter;
	}
}
